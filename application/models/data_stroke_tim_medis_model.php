...
class Data_stroke_tim_medis_model extends CI_Model
{
    ...
    {
        $this->db->where('id_data_stroke_tim_medis', $id_data_stroke_tim_medis);
        $this->db->delete('data_stroke_tim_medis');
    }
    public function ambil_id_data_stroke_tim_medis($id_data_stroke_tim_medis)
    {
        return $this->db->get_where('data_stroke_tim_medis', ['id_data_stroke_tim_medis' => $id_data_stroke_tim_medis])->row_array();
    }
    public function proses_edit_data_stroke_tim_medis()
    {
        ...
        $this->db->where('id_data_stroke_tim_medis', $this->input->post('id_data_stroke_tim_medis'));
        $this->db->update('data_stroke_tim_medis', $data);
    }
}
